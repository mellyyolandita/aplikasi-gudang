  ...
  if (isset($_POST['simpan'])) {
    ...
    if (empty($nama_file)) {
      ...
      $update = mysqli_query($mysqli, "UPDATE tbl_barang
                                       SET nama_barang='$nama_barang', harga='$harga', harga_jual='$harga_jual', stok_minimum='$stok_minimum', satuan='$satuan'
    ...
    // jika data foto ada (foto diubah)
      ...
      if (move_uploaded_file($tmp_file, $path)) {
        // sql statement untuk update data di tabel "tbl_barang" berdasarkan "id_barang"
        $update = mysqli_query($mysqli, "UPDATE tbl_barang
                                         SET nama_barang='$nama_barang', harga='$harga', harga_jual='$harga_jual', stok_minimum='$stok_minimum', satuan='$satuan', foto='$nama_file_enkripsi'
                                         WHERE id_barang='$id_barang'")
                                         or die('Ada kesalahan pada query update : ' . mysqli_error($mysqli));
        // cek query
        // jika proses update berhasil
