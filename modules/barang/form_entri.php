            ...
            <div class="col-md-7">
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <input type="text" name="harga" class="form-control mask-money" autocomplete="off" required>
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  <div class="input-group-prepend"><span class="input-group-text">Rp.</span></div>
                  <input type="text" name="harga_jual" class="form-control mask-money" autocomplete="off" required>
