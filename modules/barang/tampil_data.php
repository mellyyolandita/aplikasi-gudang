        ...
        <div class="table-responsive">
          ...
          <table id="basic-datatables" class="display table table-bordered table-striped table-hover">
            ...
            <tbody>
              ...
              $query = mysqli_query($mysqli, "SELECT a.id_barang, a.nama_barang, a.harga, a.harga_jual, a.stok, a.satuan, b.nama_satuan
              ...
              while ($data = mysqli_fetch_assoc($query)) { ?>
                ...
                <tr>
                  ...
                  <td width="120" class="text-right">Rp. <?php echo number_format($data['harga_jual'], 0, '', '.'); ?></td>
