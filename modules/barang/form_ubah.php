...
// jika file di include oleh file lain, tampilkan isi file
  ...
  if (isset($_GET['id'])) {
    ...
    $query = mysqli_query($mysqli, "SELECT a.id_barang, a.nama_barang, a.harga, a.harga_jual, a.stok_minimum, a.stok, a.satuan, a.foto, b.nama_satuan
            ...
            <div class="col-md-7">
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <input type="text" name="harga" class="form-control mask-money" autocomplete="off" value="<?php echo number_format($data['harga'], 0, '', '.'); ?>" required>
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  <div class="input-group-prepend"><span class="input-group-text">Rp.</span></div>
                  <input type="text" name="harga_jual" class="form-control mask-money" autocomplete="off" value="<?php echo number_format($data['harga_jual'], 0, '', '.'); ?>" required>
                  <div class="invalid-feedback">Harga jual tidak boleh kosong.</div>
                </div>
              </div>
