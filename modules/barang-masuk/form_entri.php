          ...
          <div class="row">
            <div class="col-md-7">
              <div class="form-group">
                ...
                // sql statement untuk menampilkan 4 digit terakhir dari "id_transaksi" pada tabel "tbl_barang_masuk"
                $query = mysqli_query($mysqli, "SELECT RIGHT(id_transaksi,4) as nomor FROM tbl_barang_masuk ORDER BY id_transaksi DESC LIMIT 1")
                ...
                $id_transaksi = "TM-" . str_pad($nomor_urut, 4, "0", STR_PAD_LEFT);
                ?>
    ...
    $(document).ready(function() {
      ...
      $('#jumlah').keyup(function() {
        ...
        // jika "jumlah" sudah diisi
          ...
          // hitung total harga
          var total_harga = eval(harga) * eval(jumlah);
        }
