  ...
  <table border="1">
    <thead>
      <tr style="background-color:#6861ce;color:#fff">
        ...
        <th height="30" align="center" vertical="center">Penerima</th>
    ...
    <tbody>
      ...
      $query = mysqli_query($mysqli, "SELECT a.id_transaksi, a.tanggal, a.barang, a.jumlah, a.penerima, b.nama_barang, c.nama_satuan
      ...
      while ($data = mysqli_fetch_assoc($query)) { ?>
        ...
        <tr>
          ...
          <td width="150" align="center"><?php echo $data['penerima']; ?></td>
