              ...
              <tbody>
                ...
                while ($data = mysqli_fetch_assoc($query)) { ?>
                  ...
                  <tr>
                    ...
                    <td width="70" class="text-center"><?php echo $data['penerima']; ?></td>
                    <td width="70" class="text-right">Rp. <?php echo number_format($data['harga'], 0, '', '.'); ?></td>
                    <td width="70" class="text-right"><?php echo number_format($data['jumlah'], 0, '', '.'); ?></td>
                    <td width="60" class="text-right">Rp. <?php echo number_format($data['total_harga'], 0, '', '.'); ?></td>
                    </tr>
                <?php
                ...
                <tr>
                  ...
                  <td class="text-right font-weight-bold">Rp. <?php echo number_format($total_keluar, 0, '', '.'); ?></td>
                </tr>
              </tbody>
            </table>
          </div>
