          ...
          <div class="table-responsive">
            ...
            <table id="basic-datatables" class="display table table-bordered table-striped table-hover">
              ...
              <tbody>
                ...
                $no = 1;
                // variabel untuk total barang masuk
                $total_masuk = 0;
                ...
                $query = mysqli_query($mysqli, "SELECT a.id_transaksi, a.tanggal, a.barang, a.supplier, a.harga, a.jumlah, a.total_harga, b.nama_barang, c.nama_satuan
                ...
                while ($data = mysqli_fetch_assoc($query)) { ?>
                  ...
                  <tr>
                    ...
                    <td width="70" class="text-center"><?php echo $data['supplier']; ?></td>
                ...
                <?php
                  // jumlahkan "masuk" untuk mendapatkan "total_masuk"
                ...
                <tr>
                  ...
                  <td class="text-right font-weight-bold">Rp. <?php echo number_format($total_masuk, 0, '', '.'); ?></td>
                </tr>
              </tbody>
            </table>
          </div>
