...
// jika user sudah login, maka jalankan perintah untuk cetak
  ...
  $html .= '			<tr>
                    ...
                    <td class="text-right font-weight-bold">Rp. ' . number_format($total_masuk, 0, '', '.') . '</td>
                  </tr>';
  $html .= '		</tbody>
              </table>
            </div>
