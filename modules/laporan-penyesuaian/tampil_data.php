  ...
  <div class="panel-header bg-secondary-gradient">
    <div class="page-inner py-4">
      <div class="page-header text-white">
        <!-- judul halaman -->
        <h4 class="page-title text-white"><i class="fas fa-file-alt mr-2"></i> Laporan Penyesuaian</h4>
        <!-- breadcrumbs -->
        <ul class="breadcrumbs">
          ...
          <li class="separator"><i class="flaticon-right-arrow"></i></li>
          <li class="nav-item"><a>Penyesuaian</a></li>
        </ul>
      </div>
    </div>
  </div>
    ...
    <div class="page-inner mt--5">
      <div class="card">
        <div class="card-header">
          <!-- judul form -->
          <div class="card-title">Filter Data Penyesuaian</div>
        </div>
        <!-- form filter data -->
        <div class="card-body">
          <form action="?module=laporan_penyesuaian" method="post" class="needs-validation" novalidate>
            <div class="row">
              <div class="col-lg-3">
            ...
            <div class="row">
              ...
              <div class="col-lg-2 pr-0">
                <div class="form-group pt-3">
                  ...
                  <a href="modules/laporan-penyesuaian/cetak.php?tanggal_awal=<?php echo $tanggal_awal; ?>&tanggal_akhir=<?php echo $tanggal_akhir; ?>" target="_blank" class="btn btn-warning btn-round btn-block mt-4">
      ...
      <div class="card">
        <div class="card-header">
          ...
          <div class="card-title">
            <i class="fas fa-file-alt mr-2"></i> Laporan Data Penyesuaian <strong><?php echo $tanggal_awal; ?></strong> s.d. <strong><?php echo $tanggal_akhir; ?></strong>
          </div>
        </div>
        <div class="card-body">
          <div class="table-responsive">
            ...
            <table id="basic-datatables" class="display table table-bordered table-striped table-hover">
              ...
              <tbody>
                ...
                // sql statement untuk menampilkan data dari tabel "tbl_penyesuaian" berdasarkan "tanggal"
                ...
                while ($data = mysqli_fetch_assoc($query)) { ?>
                  ...
                  <tr>
                    ...
                    <td width="110" class="text-center"><?php echo $data['barang']; ?> - <?php echo $data['nama_barang']; ?></td>
