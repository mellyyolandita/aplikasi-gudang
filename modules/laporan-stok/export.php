...
?>
    ...
    <table border="1">
      ...
      <tbody>
        ...
        $query = mysqli_query($mysqli, "SELECT a.id_barang, a.nama_barang, a.stok_minimum, a.stok, a.satuan, b.nama_satuan
        ...
        while ($data = mysqli_fetch_assoc($query)) { ?>
          ...
          <tr>
            ...
            <td width="500"><?php echo $data['nama_barang']; ?></td>
            <?php
            // mengecek data "stok"
  ...
  ?>
    ...
    <table border="1">
      ...
      <tbody>
        <?php
        // sql statement untuk menampilkan data dari tabel "tbl_barang" dan tabel "tbl_satuan" berdasarkan "stok"
        $query = mysqli_query($mysqli, "SELECT a.id_barang, a.nama_barang, a.stok_minimum, a.stok, a.satuan, b.nama_satuan
                                        FROM tbl_barang as a INNER JOIN tbl_satuan as b
                                        ON a.satuan=b.id_satuan 
        ...
        while ($data = mysqli_fetch_assoc($query)) { ?>
          ...
          <tr>
            ...
            <td width="200" align="right"><?php echo $data['stok']; ?></td>
            <td width="150"><?php echo $data['nama_satuan']; ?></td>
          </tr>
        <?php } ?>
      </tbody>
