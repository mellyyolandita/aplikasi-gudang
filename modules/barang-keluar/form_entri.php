          ...
          <div class="row">
            <div class="col-md-7">
              <div class="form-group">
                ...
                // sql statement untuk menampilkan 4 digit terakhir dari "id_transaksi" pada tabel "tbl_barang_keluar"
                $query = mysqli_query($mysqli, "SELECT RIGHT(id_transaksi,4) as nomor FROM tbl_barang_keluar ORDER BY id_transaksi DESC LIMIT 1")
                ...
                $id_transaksi = "TK-" . str_pad($nomor_urut, 4, "0", STR_PAD_LEFT);
                ?>
          ...
          <div class="row">
            <div class="col-md-7">
              ...
              <div class="form-group">
                ...
                <input type="text" name="penerima" class="form-control" autocomplete="off" required>
                <div class="invalid-feedback">Nama penerima tidak boleh kosong.</div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <input type="text" id="data_harga" name="harga" class="form-control mask-money" readonly>
            ...
            <div class="col-md-25 ml-auto">
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  <div class="input-group-prepend"><span class="input-group-text">Rp.</span></div>
                  <input type="text" id="total_harga" name="total_harga" class="form-control mask-money" readonly>
                  <div class="invalid-feedback">Jumlah pengeluaran tidak boleh kosong.</div>
                </div>
              </div>
            </div>
    ...
    $(document).ready(function() {
      ...
      $('#data_barang').change(function() {
        ...
        $.ajax({
          ...
          success: function(result) {                   // ketika proses get data selesai
            // tampilkan data
            $('#data_harga').val(result.harga_jual);
      ...
      $('#jumlah').keyup(function() {
        ...
        // jika "jumlah" sudah diisi
          ...
          var total_harga_jual = eval(harga_jual) * eval(jumlah);
        }

        // tampilkan sisa stok
        $('#sisa').val(sisa_stok);
        // tampilkan total stok
        $('#total_harga').val(total_harga_jual);
      });
    });
  </script>
<?php } ?>